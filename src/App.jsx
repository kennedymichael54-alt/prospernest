...
// NOTE: Uncomment these imports once you verify the build works
...
const PlaceholderTab = ({ name, theme }) => (
  <div style={{ padding: '40px', textAlign: 'center', color: theme?.textPrimary || '#333' }}>
    <h2>{name}</h2>
    <p style={{ color: theme?.textMuted || '#666' }}>Component loading...</p>
  </div>
);
const SalesTrackerTab = (props) => <PlaceholderTab name="Sales Tracker" {...props} />;
const BudgetTab = (props) => <PlaceholderTab name="Budget" {...props} />;
const BillsCalendarView = (props) => <PlaceholderTab name="Bills Calendar" {...props} />;
const GoalsTimelineWithCelebration = (props) => <PlaceholderTab name="Goals" {...props} />;
const RetirementTab = (props) => <PlaceholderTab name="Retirement" {...props} />;
const ReportsTab = (props) => <PlaceholderTab name="Reports" {...props} />;
// ============================================================================
...
const PennyLogo = ({ size = 48 }) => (
  <div style={{ display: 'inline-flex' }}>
    <svg width={size} height={size} viewBox="0 0 64 64" fill="none">
      <defs>
        <linearGradient id="coinGradientApp" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#FFD700" />
          <stop offset="50%" stopColor="#FFEC8B" />
          <stop offset="100%" stopColor="#DAA520" />
        </linearGradient>
      </defs>
      <circle cx="32" cy="32" r="26" fill="url(#coinGradientApp)" stroke="#E5A800" strokeWidth="3"/>
      ...
      <text x="32" y="18" textAnchor="middle" fontSize="10" fill="#1a1a1a" fontWeight="bold">$</text>
    </svg>
  </div>
);
...
function MainApp() {
  ...
  // For now, use the built-in LandingPage. Replace with: return <ProsperNestLandingV4 onNavigate={setView} />;
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <header style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '20px 40px', maxWidth: '1400px', margin: '0 auto' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <span style={{ background: '#007AFF', padding: '2px 8px', borderRadius: '6px', fontSize: '10px', fontWeight: '600' }}>Beta</span>
          </div>
      ...
      <div style={{ flex: 1, background: 'linear-gradient(135deg, #1e1b4b 0%, #312e81 50%, #4c1d95 100%)', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '60px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', maxWidth: '400px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', justifyContent: 'center', marginBottom: '40px' }}>
            ...
            <span style={{ background: '#007AFF', padding: '2px 8px', borderRadius: '6px', fontSize: '10px', fontWeight: '600', color: 'white' }}>Beta</span>
          </div>
...
// ============================================================================
function PennyAIChatWidget({ theme }) {
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      setMessages(prev => [...prev, { 
        role: 'assistant', 
        content: "Thanks for your message! I'm here to help you manage your finances. What would you like to know about? 💰" 
      }]);
    }, 1000);
    setInput('');
  };
      ...
      {isOpen && (
        <div style={{
          ...
          <div style={{
            ...
            <PennyLogo size={36} />
            <div>
              <div style={{ color: 'white', fontWeight: '600' }}>Penny</div>
              <div style={{ color: 'rgba(255,255,255,0.8)', fontSize: '12px' }}>Your AI Assistant</div>
            </div>
            <button
            ...
            {messages.map((msg, i) => (
              <div key={i} style={{
                ...
                <div style={{
                  ...
                  background: msg.role === 'user' ? theme.primary : theme.bgMain,
...
// IDLE TIMEOUT MODAL
// ============================================================================
function IdleTimeoutModal({ onStay, onChat, theme }) {
  return (
    <div style={{
      position: 'fixed',
      top: 0,
      ...
      <div style={{
        ...
        <PennyLogo size={64} />
        <h2 style={{ fontSize: '22px', fontWeight: '700', color: theme.textPrimary, marginTop: '20px', marginBottom: '8px' }}>
          Still there? 👋
        </h2>
        <p style={{ color: theme.textSecondary, marginBottom: '24px' }}>
          Need help exploring ProsperNest?
        </p>
...
// ============================================================================
// SETTINGS TAB - DASHSTACK STYLE (UPDATED)
// ============================================================================
function SettingsTabDS({ theme, isDarkMode, onToggleTheme }) {
  ...
  const settingsItems = [
    { 
      ...
      desc: 'Manage your bank connections',
      comingSoon: true,
      onClick: () => {}
    },
    { 
      ...
      desc: 'Invite family to collaborate',
      comingSoon: true,
      onClick: () => {}
    },
    { 
    ...
    { 
      icon: '📤', 
      title: 'Export Data', 
      desc: 'Download your financial data',
      comingSoon: true,
      onClick: () => {}
    }
  ];
        ...
        {settingsItems.map((item, i) => (
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <div>
                <div style={{ fontWeight: '600', color: theme.textPrimary, display: 'flex', alignItems: 'center', gap: '8px' }}>
                  {item.title}
                  {item.comingSoon && (
                    <span style={{
      ...
      {showPasswordModal && (
        <div style={{
          ...
          <div style={{
            ...
            <h2 style={{ fontSize: '20px', fontWeight: '700', color: theme.textPrimary, marginBottom: '24px' }}>Change Password</h2>
            
            <div style={{ marginBottom: '16px' }}>
              <label style={{ display: 'block', marginBottom: '6px', color: theme.textSecondary, fontSize: '14px', fontWeight: '500' }}>Current Password</label>
              <input
                type="password"
            ...
            <div style={{ marginBottom: '16px' }}>
              <label style={{ display: 'block', marginBottom: '6px', color: theme.textSecondary, fontSize: '14px', fontWeight: '500' }}>New Password</label>
              <input
                type="password"
            ...
            <div style={{ marginBottom: '24px' }}>
              <label style={{ display: 'block', marginBottom: '6px', color: theme.textSecondary, fontSize: '14px', fontWeight: '500' }}>Confirm New Password</label>
              <input
                type="password"
      ...
      {showNotificationsModal && (
        <div style={{
          ...
          <div style={{
            ...
            <h2 style={{ fontSize: '20px', fontWeight: '700', color: theme.textPrimary, marginBottom: '24px' }}>Notification Settings</h2>
            
            {[
              { label: 'Bill Reminders', desc: 'Get notified before bills are due' },
              { label: 'Goal Progress', desc: 'Updates on your savings goals' },
              { label: 'Budget Alerts', desc: 'When you\'re close to budget limits' },
              { label: 'Weekly Summary', desc: 'Weekly financial overview' },
            ].map((item, i) => (
              <div key={i} style={{
                display: 'flex',
                justifyContent: 'space-between',
                alignItems: 'center',
                padding: '16px 0',
                borderBottom: i < 3 ? `1px solid ${theme.borderLight}` : 'none'
              }}>
                <div>
                  <div style={{ fontWeight: '500', color: theme.textPrimary }}>{item.label}</div>
                  <div style={{ fontSize: '12px', color: theme.textMuted }}>{item.desc}</div>
                </div>
